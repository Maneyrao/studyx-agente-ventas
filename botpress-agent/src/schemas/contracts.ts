...
export const ClaimedTurnSchema = z.object({
  ...
  features: z.object({
    ...
    agent_a_state_assertions: z.boolean().optional(),
    agent_a_single_route: z.boolean().optional(),
  }).strict().optional(),
