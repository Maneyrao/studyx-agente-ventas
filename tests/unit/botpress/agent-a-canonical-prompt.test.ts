...
const EXPECTED_SHA256 = '158dbd09a7dce0093a0e25f4bc5578f974775c3f5f6e39110c06ec2258f24830';
...
describe('Agent A canonical sales prompt', () => {
  it('ships the complete approved prompt and a byte-equivalent generated module', () => {
    ...
    expect(generated).toContain("export const STUDYX_AGENT_A_CANONICAL_PROMPT_VERSION = 'studyx-agent-a-canonical-v34' as const;");
  });
});
