...
export const ConversationMoveKindV1Schema = z.enum([
  ...
  'provide_contact_details', 'decline_purchase', 'unknown',
]);
...
export const TurnPlanV1Schema = z.object({
  ...
  response_goal: z.enum([
    ...
    'confirm_selected_plan', 'acknowledge_payment_deferral', 'request_contact_details',
    'confirm_payment_link', 'acknowledge_payment_report', 'confirm_current_state',
  ...
  missing_information: z.array(z.enum([
    ...
    'call_or_chat_choice', 'payment_plan', 'payment_confirmation', 'contact_details',
    'catalog_snapshot',
  ])),
  ...
  next_awaiting_reply: z.enum(['none', 'area_choice', 'course_choice', 'call_or_chat', 'payment_plan', 'payment_confirmation', 'contact_details']),
