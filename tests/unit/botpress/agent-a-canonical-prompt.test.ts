...
const EXPECTED_SHA256 = '83c0c5bfe6b2d48eddd6fb9e1f3521373948321b4b0d93146695fe860e804d03';
...
describe('Agent A canonical sales prompt', () => {
  it('ships the complete approved prompt and a byte-equivalent generated module', () => {
    ...
    expect(generated).toContain("export const STUDYX_AGENT_A_CANONICAL_PROMPT_VERSION = 'studyx-agent-a-canonical-v13' as const;");
  });
});
