...
const EXPECTED_SHA256 = 'ce6086805e426fb4289a02b12c6d1c89cc8b091ef5704df71ef267ca6e977048';
...
describe('Agent A canonical sales prompt', () => {
  it('ships the complete approved prompt and a byte-equivalent generated module', () => {
    ...
    expect(generated).toContain("export const STUDYX_AGENT_A_CANONICAL_PROMPT_VERSION = 'studyx-agent-a-canonical-v28' as const;");
  });
});
