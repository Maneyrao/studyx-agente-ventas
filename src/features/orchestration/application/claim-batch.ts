...
export interface ClaimBatchDependencies {
  ...
  readonly agentAStateAssertions?: boolean;
...
export interface ClaimedTurn {
  ...
  readonly features: {
    ...
    readonly agent_a_state_assertions: boolean;
    readonly agent_a_single_route: boolean;
...
export async function claimBatch(
  ...
  return {
    ...
    features: {
      ...
      agent_a_state_assertions: deps.agentAStateAssertions === true,
      agent_a_single_route: deps.agentASingleRoute === true,
