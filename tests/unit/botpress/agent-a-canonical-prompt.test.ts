...
const EXPECTED_SHA256 = '7bd6d9a64bf45729cffbf19f339ae6243af39490b12b367f99b8c4ff8cd7e64c';
...
describe('Agent A canonical sales prompt', () => {
  it('ships the complete approved prompt and a byte-equivalent generated module', () => {
    ...
    expect(generated).toContain("export const STUDYX_AGENT_A_CANONICAL_PROMPT_VERSION = 'studyx-agent-a-canonical-v15' as const;");
  });
});
