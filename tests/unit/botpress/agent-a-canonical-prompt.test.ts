...
const EXPECTED_SHA256 = '31c30f80f2ffdf9e37f9300fa7e5aaacb601b55d228bca7d6786171bb1526e61';
...
describe('Agent A canonical sales prompt', () => {
  it('ships the complete approved prompt and a byte-equivalent generated module', () => {
    ...
    expect(generated).toContain("export const STUDYX_AGENT_A_CANONICAL_PROMPT_VERSION = 'studyx-agent-a-canonical-v24' as const;");
  });
});
